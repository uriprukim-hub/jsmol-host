...
}return (m4 == null ? mp.addXStr("") : asRXYZ || asABC || asXYZ ? mp.addXStr(this.matToString(m4, asRXYZ ? 0x1 : asABC ? 0xABC : 0)) : mp.addXM4(m4));
...
case 36:
case 28:
return this.vwr.getSymStatic().staticConvertOperation("", m4, (mode == 36 ? "uvw" : "xyz"));
}
}, "JU.M4,~N");
...
;//5.0.1-v5 Wed Feb 26 22:49:05 CST 2025
